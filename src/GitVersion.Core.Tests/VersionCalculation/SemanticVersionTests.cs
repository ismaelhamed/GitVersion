...
public class SemanticVersionTests : TestBase
{
    ...
    //[TestCase("1!1.0", 1, 0, 0, "", null, null, null, null, null, "1.0.0", null, SemanticVersionFormat.Pep440)]
    //[TestCase("2014.04", 2014, 4, 0, "", null, null, null, null, null, "2014.4.0", null, SemanticVersionFormat.Pep440)]
    //[TestCase("1.0", 1, 0, 0, "", null, null, null, null, null, "1.0.0", null, SemanticVersionFormat.Pep440)]
    //[TestCase("1.1.0", 1, 1, 0, "", null, null, null, null, null, "1.1.0", null, SemanticVersionFormat.Pep440)]
    [TestCase("1.1a12.dev456", 1, 1, 0, "a", 12, null, null, null, null, "1.1.0-a.12", null, SemanticVersionFormat.Pep440)]

    //[TestCase("1.0+local.1", 1, 0, 0, "", null, null, null, null, "local.1", "1.0.0+local.1", null, SemanticVersionFormat.Pep440)]
    //[TestCase("1.0+exp.sha.5114f85", 1, 0, 0, "", null, null, null, null, "exp.sha.5114f85", "1.0.0+exp.sha.5114f85", null, SemanticVersionFormat.Pep440)]
    //[TestCase("2.0.0+linux.x86_64", 2, 0, 0, "", null, null, null, null, "linux.x86_64", "2.0.0+linux.x86-64", null, SemanticVersionFormat.Pep440)]
    //[TestCase("2.0.0+windows.build12", 2, 0, 0, "", null, null, null, null, "windows.build12", "2.0.0+windows.build12", null, SemanticVersionFormat.Pep440)]
    //[TestCase("2.1.3+customerA.2", 2, 1, 3, "", null, null, null, null, "customerA.2", "2.1.3+customerA.2", null, SemanticVersionFormat.Pep440)]
    //[TestCase("2.3.1+alpha.2.customerA", 2, 3, 1, "", null, null, null, null, "alpha.2.customerA", "2.3.1+alpha.2.customerA", null, SemanticVersionFormat.Pep440)]
